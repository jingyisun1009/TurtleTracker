...
# ARGOSTracker.py
#
# scription: Parses a line of ARGOS tracking data
#
# reated by: Jingyi Sun (jingyi.sun@duke.edu)
...
obsDate = obsDateTime.split()[0] # Observation date - first item in bsDateTime list object
obsTime = obsDateTime.split()[1] # Observation time - second item in bsDateTime list object
